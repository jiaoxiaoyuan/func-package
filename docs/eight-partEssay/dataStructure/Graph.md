...
- 图长什么样子呢？或者什么样的数据使用图来模拟更合适呢？
  ...
  - 人与人之间的关系网
    ![img](./assets/img-57.CVnbWCsK.png)

  - 互联网中的网络关系
    ![img](./assets/img-58.DsKVcRrH.png)

  - 广州地铁图
    ![img](./assets/img-59.WnJUMLNZ.png)
...
![img](./assets/img-60.DHbrE9Cp.png)
...
- 带权图
  ...
  - 我们来看一张有向和带权的图：
    ![img](./assets/img-61.xQboukRP.png)
...
- 概述
  ...
  ![img](./assets/img-62.Co9igEV2.png)
...
- 概述
  ...
  ![img](./assets/img-63.DVe5GmMC.png)
...
- 图解 BFS
  ![img](./assets/img-64.CHol7hFG.png)
...
- 接着原路回退并探索下一条路径。
- 图解 DFS
  ![img](./assets/img-65.BLZzuMbA.png)
...
- 递归的代码较难理解一些，这副图来帮助理解过程：
  ![img](./assets/img-66.DsFra2Qx.png)
