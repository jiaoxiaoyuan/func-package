...
1. 定位到Android Studio工具栏，如图1-2所示：
   ...
   ![图1-3](./assets/1-2.656e852b-20241009213841162.png)
...
![image-20241009214716418](./assets/image-20241009214716418.png)

安装之后重新运行即可，如图1-8：

![install_request_components.png](./assets/1-8.69ea9a5c.png)
...
![下载依赖失败](./assets/1-9.a2561ece.png)
