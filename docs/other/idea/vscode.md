...
![](./assets/20190313_1750_3.png)

上图中，直接点击 download，一键下载安装即可。

VS Code支持以下平台：

![](./assets/20210930_1930.png)

安装完成后的界面如下：

![](./assets/20211011_1703.png)
...
![](./assets/20190329_2120.png)

### 11、快捷键列表

你可以点击 VS Code 左下角的齿轮按钮，效果如下：

![](./assets/20190418_1738.png)

上图中，在展开的菜单中选择「键盘快捷方式」，就可以查看和修改所有的快捷键列表了：

![](./assets/20190418_1739_2.png)
...
![](./assets/20190414_1751.png)

### 5、使用命令行启动 VS Code

（1）输入快捷键「Cmd + Shift + P 」，选择`install code command`：

![](./assets/20191103_1327.png)
...
![](./assets/20210930_2009.png)

**方式2**：点击软件右下角的设置图标：

![](./assets/20210930_2016.png)

![](./assets/20211012_1017.png)
...
![](./assets/20210930_2017.png)

在弹出的对话框中，挑选你一个你喜欢的的颜色主题吧，或者安装其他颜色的主题：

![20211013_1018](./assets/20211013_1018.png)
...
![20211013_1015](./assets/20211013_1015.png)

在弹出的对话框中，挑选你一个你喜欢的的主题吧，或者安装其他的主题：

![20211013_1019](./assets/20211013_1019.png)
...
![](./assets/20191108_1550.png)

上图中，将红框部分打钩即可。

设置成功后，我们就可以查看到当前文件的「层级结构」，非常方便。如下图所示：

![](./assets/20190415_2009.png)
...
![20211012_2014](./assets/20211012_2014.png)
...
![20211012_1049](./assets/20211012_1049.png)

### 10、设置字体大小

在设置项里搜索`fontSize`，然后根据需要设置各种模块的字体大小：

![20211012_1053](./assets/20211012_1053.png)
...
![20211012_1150](./assets/20211012_1150.png)

修改之后，代码里的空格、缩进的展示效果如下：

![20211012_1258](./assets/20211012_1258.png)
...
![20211012_1704](./assets/20211012_1704.png)
...
![20211012_1548](./assets/20211012_1548.png)
...
![20211012_1616](./assets/20211012_1616.png)
...
![20211013_1411](./assets/20211013_1411.png)

上图中，点击右上角的`...`，然后点击`内联视图`，则可以换一种视图 diff 代码：

![](./assets/20211013_1415.png)

**Git状态栏**：

![20211013_1421](./assets/20211013_1421.png)
...
![](./assets/20190418_2022.png)

那么，就可以创建多层子文件夹，效果如下：

![](./assets/20190418_2023.png)
...
![20211013_1120](./assets/20211013_1120.png)
...
![20211013_1757_2](./assets/20211013_1757_2.png)
...
![20211013_1758](./assets/20211013_1758.png)

![20211013_1955](./assets/20211013_1955.png)
...
![20211013_2011](./assets/20211013_2011.png)

2）在搜索框输入字符`@`，会展示出不同类型的过滤器：

![20211013_2015](./assets/20211013_2015.png)
...
![](./assets/20211009_1400.png)

安装了  GitLens 之后是这样的：

![](./assets/20211009_1430.png)
...
![](./assets/20190418_2012.png)

上图中，点击红框部分，登录后就可以分享你的工作空间了。

![](./assets/20190418_2005.png)
...
![](./assets/20200521_1530.png)

上图中，我们点击最新的那条记录，就可将云端的最新配置同步到本地：

![](./assets/20200521_1550.png)
